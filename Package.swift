...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "NetworkManager",
            url: "https://github.com/Amin-0-1/NetworkManager/releases/download/1.3.6/RELEASE.xcframework.zip",
            checksum: "f3ce305f1bd7785eda01af9508f64fb85c85781ff5f030db4b9932cebefeb8c2"
        ),
        .binaryTarget(
            name: "NetworkManager-debug",
            url: "https://github.com/Amin-0-1/NetworkManager/releases/download/1.3.6/DEBUG.xcframework.zip",
